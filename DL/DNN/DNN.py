...
class DNN:
    ...
    def __init__(self):
        print("__init__");
    def __init__(self,num_epochs = 20, batch_size=30, filterNum=1, bias=True, activation='relu', output_layer_activation='linear', output_loss='mse'): #, output_loss='mse'):
    ...
    def build_DNN(self, pVal, n_outputs ,coeff=0):
        ...
        model.compile(loss='mse', optimizer='adam')#model.compile(loss=self.output_loss, optimizer='adam')
        return model;
    def train_DNN(self, model, X_train, y_train, callback, class_weights=None):
